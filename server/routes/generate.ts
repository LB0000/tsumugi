...
const stylePrompts: Record<string, string> = {
  // 西洋絵画
  'baroque': 'Transform this photo into a dramatic 17th-century Baroque masterpiece in the style of Rembrandt or Caravaggio. Apply multiple glazing layers of rich oil paint with visible impasto brushwork in highlights. Use a deep, dark background — near-black shadows enveloping the scene in the tenebrism technique, with only the subject dramatically illuminated by a single warm light source from the side. Create intense chiaroscuro lighting — deep dramatic shadows contrasting with warm golden highlights illuminating the face. Render skin with luminous warmth using layered translucent oils. AVOID: flat or digital-looking colors; the paint texture must feel thick and physical. AVOID: velvet drapes, thrones, crowns, or royal palace elements — this is about painting technique, not royalty.',
