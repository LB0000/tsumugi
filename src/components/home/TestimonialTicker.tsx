...
const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    initial: '佐',
    rating: 5,
    comment: '家族写真をダヴィンチ風クラシックで仕上げてもらいました。祖母の誕生日に贈ったら涙を流して喜んでくれました。',
    style: 'ダヴィンチ風クラシック',
    category: 'family',
  ...
  },
  {
    ...
    initial: '高',
    rating: 5,
    comment: '王室の豪華肖像画スタイルが本当に美術館の絵のよう。技術の高さに感動しました。部屋の雰囲気が一気に変わりました。',
    style: '王室の豪華肖像画',
    category: 'pets',
  ...
  },
  {
    ...
    initial: '伊',
    rating: 4,
    comment: '結婚記念日のサプライズに。夫婦の肖像画を光のやわらか絵画で仕上げてもらいました。妻がとても喜んでくれて大満足です。',
    style: '光のやわらか絵画',
    category: 'family',
